...
public class AlertaController {
    ...
    @PostMapping
    public ResponseEntity<AlertaResponseDto> criarAlerta(@RequestBody CriarAlertaCommand command) {
        Alerta alerta = criarAlertaUseCase.executar(command);
        AlertaResponseDto alertaCadastrado = AlertaMapper.toResponseDto(alerta);
