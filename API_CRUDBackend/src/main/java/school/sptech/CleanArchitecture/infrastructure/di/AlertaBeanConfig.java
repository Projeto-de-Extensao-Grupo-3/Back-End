...
public class AlertaBeanConfig {
    ...
    @Bean
    public AlertaListarAlertasDoItemUseCase alertaListarAlertasDoItemUseCase(AlertaAdapter alertaAdapter){
        return new AlertaListarAlertasDoItemUseCase(alertaAdapter);
    }
