...
public class PermissaoService {
    ...
    public Permissao cadastrar(Permissao permissaoParaCadastrar) {
    ...
    public Permissao atualizar(Integer id, Permissao permissaoParaAtualizar) {
        ...
        throw new PermissaoConflitoException("A permissão não existe");
    }
